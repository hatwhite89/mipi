<%@ Page Language="vb"  MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="frmSubirExcelDesnutricion.aspx.vb" Inherits="mipi.frmSubirExcelDesnutricion" %>

    <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <form runat="server">
        <div class="container">

            <h2>Cargar base de datos desnutricion niños  de 6 a 24 Meses de edad</h2>
            <p>Instrucciones</p>
            <p>Descargue el formato en Excel que se encuentra mas abajo,busque el municipio y agregue la cantidad que corresponde a cada municipio.</p>
