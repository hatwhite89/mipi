<%@ Page Language="vb" MasterPageFile="~/Site.Master"  AutoEventWireup="false" CodeBehind="frmSubirExcelNominalCuidadores.aspx.vb" Inherits="mipi.frmSubirExcelNominalCuidadores" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <form runat="server">
        <div class="container">
            ...
            <br />
            <a href="../Uploads/Ejemplo BD desnutricion.xlsx" target="_blank">Formato de Excel</a>
            <br />
        </div>
